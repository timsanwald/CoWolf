package de.uni_stuttgart.iste.cowolf.skeleton.ui.analyze;
...
import de.uni_stuttgart.iste.cowolf.skeleton.analyze.SkeletonAnalyzer;
...
public class AnalyzeWizard extends AbstractQoSAnalyzeWizard {
	...
	public boolean isManaged(final AbstractAnalyzer analyzer) {
		...
		return analyzer instanceof SkeletonAnalyzer;
	}
