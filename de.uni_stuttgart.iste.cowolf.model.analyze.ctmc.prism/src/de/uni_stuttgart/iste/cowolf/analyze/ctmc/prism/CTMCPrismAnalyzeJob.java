...
import de.uni_stuttgart.iste.cowolf.analyze.ctmc.prism.PRISMGenerator;
import de.uni_stuttgart.iste.cowolf.model.ctmc.CTMC;

public class CTMCPrismAnalyzeJob extends Job {
	
	private final static Logger LOGGER = LoggerFactory
			.getLogger(CTMCPrismAnalyzeJob.class);
	 ...
	 * 
	 */
	public CTMCPrismAnalyzeJob(final Resource model,
	...
	protected IStatus run(final IProgressMonitor monitor) {
		...
		try {
			...
			this.prismResult = new ArrayList<CTMCPrismAnalyzeJob.Result>();
