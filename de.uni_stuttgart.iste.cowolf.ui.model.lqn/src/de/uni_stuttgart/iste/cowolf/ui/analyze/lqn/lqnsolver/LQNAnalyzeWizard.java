package de.uni_stuttgart.iste.cowolf.ui.analyze.lqn.lqnsolver;
...
import de.uni_stuttgart.iste.cowolf.analyze.lqn.lqnsolver.LQNSolverAnalyzer;
import de.uni_stuttgart.iste.cowolf.model.AbstractQoSModelManager;
import de.uni_stuttgart.iste.cowolf.model.lqn.LQNModelManager;
import de.uni_stuttgart.iste.cowolf.ui.analyze.lqn.lqnsolver.preferences.LQNSolverPreferencePage;
...
public class LQNAnalyzeWizard extends AbstractQoSAnalyzeWizard{
	...
	public boolean performFinish() {
		...
		properties.put(LQNModelManager.PARAM_PATH_TO_LQN_SOLVER, LQNSolverPreferencePage.getPathToLQNSolver());
		return true;
	}
	
	@Override
	public boolean isManaged(AbstractAnalyzer analyzer) {
		return analyzer instanceof LQNSolverAnalyzer;
	}
	...
	private boolean checkLQNSolverPath(){
		String path = LQNSolverPreferencePage.getPathToLQNSolver().trim();
