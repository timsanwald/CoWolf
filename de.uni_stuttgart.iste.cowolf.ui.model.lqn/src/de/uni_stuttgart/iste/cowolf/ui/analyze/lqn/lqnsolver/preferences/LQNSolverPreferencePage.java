package de.uni_stuttgart.iste.cowolf.ui.analyze.lqn.lqnsolver.preferences;
...
import de.uni_stuttgart.iste.cowolf.ui.analyze.lqn.lqnsolver.Activator;

public class LQNSolverPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {

	private static final String PATH_TO_LQN_KEY = "PATH_TO_LQN";
	
	public LQNSolverPreferencePage(){
		super(GRID);
