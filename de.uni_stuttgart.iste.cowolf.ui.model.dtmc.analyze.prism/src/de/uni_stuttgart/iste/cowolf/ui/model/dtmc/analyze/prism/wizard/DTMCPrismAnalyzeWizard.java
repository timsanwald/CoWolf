package de.uni_stuttgart.iste.cowolf.ui.model.dtmc.analyze.prism.wizard;
...
import de.uni_stuttgart.iste.cowolf.model.analyze.dtmc.prism.DTMCPrismAnalyzer;
import de.uni_stuttgart.iste.cowolf.ui.model.analyze.AbstractQoSAnalyzeWizard;
import de.uni_stuttgart.iste.cowolf.ui.model.dtmc.analyze.prism.preference.DTMCPrismPreferencePage;

public class DTMCPrismAnalyzeWizard extends AbstractQoSAnalyzeWizard {

	protected AnalyzeWizardPage1 pageOne;
	private AnalyzeWizardPage2 pageTwo;

	public DTMCPrismAnalyzeWizard() {
		super();
	}
	...
	public boolean performFinish() {
		...
		this.properties.put("prismRootPath", DTMCPrismPreferencePage.getPrismPath());
		return true;
	}
	...
	@Override
	public boolean isManaged(final AbstractAnalyzer analyzer) {
		return analyzer instanceof DTMCPrismAnalyzer;
	}
	...
	public boolean checkConditions() {
		String path = DTMCPrismPreferencePage.getPrismPath().trim();
