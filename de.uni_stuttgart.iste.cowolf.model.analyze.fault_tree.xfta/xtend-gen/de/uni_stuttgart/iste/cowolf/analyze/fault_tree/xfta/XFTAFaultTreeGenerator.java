...
public class XFTAFaultTreeGenerator implements XFTAGenerator {
   ...
   */
  private final Map<String, String> gates = Collections.<String, String>unmodifiableMap(CollectionLiterals.<String, String>newHashMap(Pair.<String, String>of("and", "and"), Pair.<String, String>of("or", "or"), Pair.<String, String>of("inhibit", "and"), Pair.<String, String>of("priorand", "and"), Pair.<String, String>of("xor", "or")));
  ...
  public CharSequence fillGateContent(final Gate gate) {
    ...
    String _translateGate = this.translateGate(_lowerCase);
    _builder.append(_translateGate, "   \t");
    _builder.append(">");
    _builder.newLineIfNotEmpty();
    {
    ...
    String _translateGate_1 = this.translateGate(_lowerCase_1);
    _builder.append(_translateGate_1, "   \t");
    _builder.append(">");
    _builder.newLineIfNotEmpty();
    return _builder;
  }
  
  public String translateGate(final CharSequence s) {
    return this.gates.get(s);
  }
}
